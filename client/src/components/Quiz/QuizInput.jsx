  ...
  ({ label, name, value, onChange, type = "text", ...props }) => (
    <div className="md:mb-3 mb-2">
      ...
      <input
        ...
        onChange={onChange}
        {...props}
        className="mt-1 block w-full rounded-lg border border-gray-300 bg-white py-1 px-2 md:py-2  shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
      />
    </div>
  )
);
